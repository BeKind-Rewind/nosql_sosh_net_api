...
function printUser(userData) {
  ...
  const { userName, createdBy, createdAt, thoughts } = userData;
...
function printThought(thought) {
  ...
  const thoughtContent = `
      <h5 class="text-dark">${thought.writtenBy} thought on ${thought.createdAt}:</h5>
      ...
      <form class="reaction-form mt-3" data-thoughtid='${thought._id}'>
        <div class="mb-3">
          <label for="reaction-name">User Name</label>
